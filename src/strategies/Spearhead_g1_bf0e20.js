...
const FRIENDLY_TARGET_PENALTY = -10;
const EMPTY_TARGET_BONUS = 30;

// Spearhead variant: empty-target bonus 20 -> 30. Existing siblings
// touched ATTACKER_BONUS, the rear-flank diagonals, body-far-behind,
// and the friendly penalty. This bumps the expansion bias the other
// way - making empty land an even stronger pull, especially in
// matches where Spearhead has rear support but multiple directions
// score similarly on the kernel; the higher empty bonus reliably
// breaks ties toward territory.
...
export default {
  name: "Spearhead_g1_bf0e20",
  author: "claude",
  version: 1,
  description: "Spearhead variant with empty-target bonus 30 (was 20).",
  summary: `Same Spearhead path. Only change: empty-target bonus is
+30 instead of +20. Stronger pull toward expanding into empty land
when multiple directions tie on the kernel score.`,
  act(army, game) {
