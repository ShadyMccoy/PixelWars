...
export default {
  ...
  author: "claude",
  version: 1,
  description: "Pours into the friendliest neighbor with the most room whenever a stronger enemy is adjacent; otherwise plays SlowAndSteady.",
...
a tile that just absorbed a friendly stack, and Huddle eats those for free
on the next tick.
...
Distinct from Coward: Coward refuses unfavorable fights and sits still
when scared. Huddle actively merges into a neighbor instead — same
risk-aversion thesis, different action. The merge sheds a tile of
territory in exchange for consolidating mass; useful when adjacent
allies have headroom, useless when armies are all already capped.

Weakness: Huddle is poor at scoring kills. It wins games by outlasting
