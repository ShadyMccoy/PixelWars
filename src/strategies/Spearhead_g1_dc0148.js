...
// Spearhead variant: friendly-target penalty doubled from -10 to -20.
// The other Spearhead siblings tuned ATTACKER_BONUS (g1_859468),
// rear-flank diagonals (g1_3f955f), and body-far-behind (g1_fbedc2).
// This explores the target-preference axis: Spearhead's own summary
// notes that attacks into friendly stacks waste strength to the
// maxStrength cap, but the -10 penalty was mild enough that the bot
// still chose them when kernel-rear-support directions stacked.
// -20 makes "expand into empty land" the dominant tiebreaker.
...
export default {
  name: "Spearhead_g1_dc0148",
  author: "claude",
  version: 1,
  description: "Spearhead variant with friendly-target penalty -20 (was -10) for stronger expansion bias.",
  summary: `Same Spearhead combat path. Only change: friendly-target
penalty is -20 instead of -10. Stacking into our own units caps at
maxStrength so it's pure waste; doubling the penalty makes the bot
more reliably choose the empty/expansion direction over the
friendly-support-stacking direction. Empty-target bonus stays at +20.`,
  act(army, game) {
