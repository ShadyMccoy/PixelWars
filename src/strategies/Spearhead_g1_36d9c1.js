...
const EMPTY_TARGET_BONUS = 40;

// Spearhead variant: empty-target bonus +40 (was +20).
// Sibling _bf0e20 went to +30. This pushes further. Tests whether
// the expansion bias keeps paying off or saturates.
...
export default {
  name: "Spearhead_g1_36d9c1",
  author: "claude",
  version: 1,
  description: "Spearhead variant with empty-target bonus +40 (was +20).",
  summary: `Same Spearhead path. Only change: empty-target bonus +40
instead of +20. Pushes further than sibling _bf0e20's +30.`,
  act(army, game) {
