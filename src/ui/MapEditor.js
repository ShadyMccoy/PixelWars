...
export class MapEditor {
  constructor({ app }) {
    ...
    const inputs = [this.width, this.height, this.growth, this.maxArmy, this.attrition, this.players, this.wrap];
  ...
  write({ width, height, growth, maxArmy, attritionRate, wrap, numPlayers }) {
